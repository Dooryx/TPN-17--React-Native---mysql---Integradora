  ...
  return (
    <View>
      ...
      <View style={styles.buttonContainer}>
        <Button title="Mostrar todo" onPress={handlePressButton1} style={styles.Boton} color={'#83AF9E'}/>
        <Button title="Jugadores Argentinos" onPress={handlePressButton2} style={styles.Boton} color={'#83AF9E'}/>
        <Button title="Jugadores entre 75 y 80 kg" onPress={handlePressButton3} style={styles.Boton} color={'#83AF9E'}/>
        <Button title="Jugador más alto" onPress={handlePressButton4} style={styles.Boton} color={'#83AF9E'}/>
      </View>
    </View>
  );
};
